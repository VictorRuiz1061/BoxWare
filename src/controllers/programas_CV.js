...
export const buscarPrograma = async (req, res) => {
    ...
    try {
        const result = await pool.query('SELECT * FROM programas WHERE id_programa = $1', [id_programa]);
...
export const actualizarPrograma = async (req, res) => {
    ...
    try {
        ...
        const result = await pool.query(sql, [nombre_programa, area_id, id_programa]);
